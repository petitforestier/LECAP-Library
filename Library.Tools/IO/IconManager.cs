...
namespace Library.Tools.IO
{
    ...
    public static class IconManager
    {
        ...
        public static Image FindIconForFileName(string fileName, bool large)
        {
